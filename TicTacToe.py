...
class Board:
    ...
    def checkWinner(self, player):
        if (self.spots[1][0]==player.name and self.spots[2][0]==player.name and self.spots[3][0]==player.name) or (self.spots[4][0]==player.name and self.spots[5][0]==player.name and self.spots[6][0]==player.name) or (self.spots[7][0]==player.name and self.spots[8][0]==player.name and self.spots[9][0]==player.name):
            return player.name
        elif (self.spots[1][0]=='p1' and self.spots[4][0]=='p1' and self.spots[7][0]=='p1') or (self.spots[2][0]=='p1' and self.spots[5][0]=='p1' and self.spots[8][0]=='p1') or (self.spots[3][0]=='p1' and self.spots[6][0]=='p1' and self.spots[9][0]=='p1'):
            return player.name
        elif (self.spots[1][0]=='p1' and self.spots[5][0]=='p1' and self.spots[9][0]=='p1') or (self.spots[3][0]=='p1' and self.spots[5][0]=='p1' and self.spots[7][0]=='p1'):
            return player.name
